...
let configUrl = [{
    ...
    title: '药贷宝详情',
    index: '5',
    android: 'com.yaocaimaimai.yaocaimaimai.mvp.main.personal.yaodaibao.introduce.YaodaibaoIntroduceActivity',
    ios: 'YCMM://push/YCMMYdbQAViewController'
}];
        ...
        methods: {
            ...
            selecteAppUrl(val) {
                ...
                if (val === '0') {} else if (val === '1') {
                    ...
                    this.activityParam.shareUrl = 'apps://ycmm?android=' + configUrl[5].android + '&ios=' + configUrl[5].ios
                }
            },
            selectAppType(val) {
