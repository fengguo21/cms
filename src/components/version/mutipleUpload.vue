...
<template>
    <div class="img_upload" :v-loading.body="loading">
        <form>
            ...
            <div class="uploader-icon" v-show="imgUrl" v-on:mouseenter="showModel = true" v-on:mouseleave="showModel = false">
                <img v-for="(item,index) in imgUrl"  v-bind:src="item" class="icon">
